...
% Last Modified by GUIDE v2.5 24-Jun-2016 18:57:21
...
function button1_Callback(hObject, eventdata, handles)
 grade=calculate( str2num(get(handles.edit1,'string')),str2num(get(handles.edit2,'string')),str2num(get(handles.edit3,'string')));
       %this functions get and convert those strings to integer number and
       %send them to calculate function
    set(handles.text4,'String',grade);
